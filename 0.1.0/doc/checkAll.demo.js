...
/******/ 	__webpack_require__.p = "/picker-logic/0.1.0";
/******/
...
var _pickerLogic = __webpack_require__("./lib/index.js");

var _pickerLogic2 = _interopRequireDefault(_pickerLogic);

var _jsonFormat = __webpack_require__("./node_modules/json-format/index.js");
...
var sham = __webpack_require__("./node_modules/shamjs/lib/index.js");
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                __webpack_require__("./node_modules/react/index.js").createElement("input", { type: "checkbox", checked: self.props.checked, onChange: function onChange(e) {
...
var list = new sham.List({
    dataCount: 123,
    generator: function generator(index) {
        var num = index + 1;
        return {
            id: 'id-' + num,
            text: 'text-' + num
    ...
    onSearch: function onSearch(item, search) {
        return item.text.indexOf(search) !== -1;
    }
});

var App = (_temp = _class = function (_Component2) {
    ...
    _createClass(App, [{
        ...
        value: function componentWillMount() {
            ...
            self.picker = new _pickerLogic2.default({
                ...
                onChange: function onChange(stat) {
                    var state = self.state;
                    state.stat = stat;
                    self.setState(state);
                }
        ...
        value: function render() {
            ...
            return __webpack_require__("./node_modules/react/index.js").createElement(
                ...
                null,
                "\u9009\u4E2D(",
                self.state.stat.mode === 'check' ? self.state.stat.checked.length : self.state.dataCount - self.state.stat.unchecked.length,
                ") \u4E2A",
                __webpack_require__("./node_modules/react/index.js").createElement(
                    "label",
                    null,
                    __webpack_require__("./node_modules/react/index.js").createElement("input", { type: "checkbox", checked: self.state.stat.mode === 'uncheck' && self.state.stat.type === 'empty', onChange: function onChange(e) {
                            if (e.target.checked) {
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    "label",
                    null,
                    __webpack_require__("./node_modules/react/index.js").createElement("input", { type: "checkbox", checked: self.state.stat.viewDataCheckedAll, onChange: function onChange(e) {
                            if (e.target.checked) {
                ...
                self.state.data.map(function (item, key) {
                    var checked = self.state.stat.checked.indexOf(item.id) !== -1;
                    return __webpack_require__("./node_modules/react/index.js").createElement(Item, { key: key, id: item.id, text: item.text, checked: checked, onChange: self.change });
                }),
                __webpack_require__("./node_modules/react/index.js").createElement(
                    "button",
                    { type: "button", onClick: self.prev },
                    "prev(",
                    self.state.page,
                    ")"
                ),
                ...
                __webpack_require__("./node_modules/react/index.js").createElement(
                    "pre",
                    null,
                    (0, _jsonFormat2.default)(self.state.stat)
                )
            );
        }
    }]);
    ...
    this.renderList = function (page, data) {
        var self = _this3;
        var state = self.state;
        state.page = page;
        state.data = data;
...
/*ONFACE-DEL*/
App = __webpack_require__("./node_modules/react-hot-loader/index.js").hot(module)(App);
module.exports = App;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__("./node_modules/webpack/buildin/module.js")(module)))

/***/ }),

/***/ "./doc/checkAll.demo.js":
/***/ (function(module, exports, __webpack_require__) {
...
var Basic = __webpack_require__("./doc/CheckAll.js");
ReactDOM.render(__webpack_require__("./node_modules/react/index.js").createElement(Basic, null), document.getElementById('checkAll-demo'));
...
var Picker = (_temp = _class = function () {
    _createClass(Picker, null, [{
        key: 'getDefaultSettings',
        value: function getDefaultSettings() {
            return {
                data: [],
                onChange: function onChange(stats) {},
                getDataCount: function getDataCount() {
    ...
    function Picker(settings) {
        ...
        var self = this;
        settings = (0, _extend2.default)(true, Picker.getDefaultSettings(), settings);
    ...
    _createClass(Picker, [{
        key: 'triggerChange',
        value: function triggerChange(method) {
            var self = this;
            var type = void 0;
            var stats = {
                mode: null,
            ...
            var dataCount = self.settings.getDataCount();
            ...
            if (typeof self.settings.getViewData === 'function') {
                var viewData = self.settings.getViewData();
                stats.viewDataCheckedAll = false;
                if (viewData.length !== 0) {
                    var viewDataCheckedCount = 0;
                    viewData.some(function (id) {
                        var unchecked = self.data.forEach(function (item) {
    ...
    this._find = function (id, handler, caller) {
        var self = _this;
        self.data = self.data.map(function (item) {
            if (_typeof(item.id) !== (typeof id === 'undefined' ? 'undefined' : _typeof(id))) {
                console.warn('node_modules/picker-mode/lib/index.js _find: ' + caller + '(id) typeof id === "' + (typeof id === 'undefined' ? 'undefined' : _typeof(id)) + '" | typeof data[index].id === ' + _typeof(item.id));
            }
            if (item.id === id) {
                item = handler(item);
            }
    ...
    this.concat = function (idArray) {
        var self = _this;
        var dataID = self.data.map(function (item) {
            return item.id;
        });
        var newData = idArray.map(function (id) {
            if (dataID.indexOf(id) !== -1) {
                return false;
            } else {
                var checked = self.mode !== 'check';
                return {
                    id: id,
                    checked: checked
                };
    ...
    this.onlyCheck = function (idArray) {
        var self = _this;
...
/***/ "./node_modules/shamjs/lib/index.js":
/***/ (function(module, exports, __webpack_require__) {

module.exports = {
    List: __webpack_require__("./node_modules/shamjs/lib/list.js")
}


/***/ }),

/***/ "./node_modules/shamjs/lib/list.js":
/***/ (function(module, exports, __webpack_require__) {
...
function List(settings) {
    ...
    settings = extend(true, {
        ...
        generator: function (index) {
            return {
                text: 'text' + Math.floor(Math.random() * 10000),
    ...
    self.data = []
    var i = 0
    for(;i<settings.dataCount;i++) {
        self.data.push(self.settings.generator(i))
    }
    i = undefined
}
List.prototype.query = function (request) {
    var self = this
    var data = self.data
    if (typeof request.search !== 'undefined') {
        data = data.filter(function (item) {
            return self.settings.onSearch(item, request.search)
        })
    }
...
List.prototype.getDataCount = function () {
...
module.exports = __webpack_require__("./doc/checkAll.demo.js");
